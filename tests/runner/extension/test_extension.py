...
def test_good_ext_loader(echo_context: None, monkeypatch: pytest.MonkeyPatch, display_collector: t.List[str]) -> None:
    ...
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "good_loader.py"))
...
def test_ext_loader_missing_attr(echo_context: None, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "empty_loader.py"))
...
def test_ext_loader_bad_no_args_action(echo_context: None, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "bad_no_args_actions_loader.py"))
...
def test_ext_loader_bad_arg_name_action(echo_context: None, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "bad_arg_name_actions_loader.py"))
...
def test_ext_loader_invalid_source(echo_context: None, monkeypatch: pytest.MonkeyPatch) -> None:
    """Check non-module"""
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "non_loader.txt"))
...
def test_ext_loader_missing_source(echo_context: None, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("CJUNCT_WORKFLOW_LOADER_SOURCE_FILE", str(MODULES_DIR / "missing_loader.py"))
